    ...
    <div class="hwh-nav-bar">
        <div class="hwh-nav-bar__inner">
                        ...
                        <div class="hwh-drop">
                            <div class="hwh-drop__inner">
                                ...
                                <div class="hwh-drop__promo">
                                    ...
                                    <a href="#request-service" class="hwh-drop__promo-btn">Book Now →</a>
                                </div>
                            </div>
            ...
            <div class="hwh-nav__actions">
                ...
                <a href="#request-service" class="hwh-btn hwh-btn--red hwh-btn--sm">Book Service</a>
...
<div class="mobile-menu" id="mobile-menu" role="dialog" aria-label="Mobile navigation" aria-hidden="true">
    ...
    <div class="mobile-menu__drawer">
        ...
        <div class="mobile-menu__footer">
            <a href="#request-service" class="hwh-btn hwh-btn--red" style="width:100%;justify-content:center;">Book a Service</a>
