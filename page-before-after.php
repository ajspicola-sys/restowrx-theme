...
<main class="site-main" id="main-content" style="background:#050505; color:#ffffff; font-family:var(--font-main, 'Inter', sans-serif); overflow-x:hidden;">
    ...
    <section class="page-hero" aria-label="Before and after gallery">
        ...
        <div class="page-hero__inner reveal">
            <span class="section__label">Real Operational Results</span>
    ...
    <section class="cta-section" aria-label="Request service">
        <div class="cta-section__inner reveal">
            ...
            <div class="cta-section__actions">
                <a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn btn--primary btn--lg" style="font-family:var(--font-accent); font-size:1.3rem; letter-spacing:1px; padding:10px 30px;">Request Service</a>
            </div>
        </div>
    </section>
