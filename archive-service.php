 ...
 * Uses the same card grid as the homepage.
 */
get_header();
?>
...
<main class="site-main" id="main-content">
    ...
    <section class="hwh-hero hwh-hero--inner" aria-label="Our plumbing services">
        ...
        <div class="hwh-section-inner" style="position:relative;z-index:2;text-align:center;padding-top:2rem;padding-bottom:2rem;">
            ...
            <p class="hwh-section-desc hwh-section-desc--muted">Licensed plumbers ready same-day — water heaters, drains, leaks, and 24/7 emergencies.</p>
            <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap;margin-top:2rem;">
                <a href="/contact/" class="hwh-btn hwh-btn--red hwh-btn--lg">Request Service</a>
        ...
        <div class="hwh-section-inner">
            ...
            <?php else : ?>
                <div style="text-align:center;padding:4rem 0;">
                    <p style="font-size:1.1rem;color:#3D6491;">No services found. <a href="/contact/">Contact us directly</a>.</p>
                </div>
            <?php endif; ?>
    ...
    <section class="hwh-cta" aria-label="Emergency plumbing CTA">
        <div class="hwh-cta__inner">
            <div>
                <h2 class="hwh-cta__title">Plumbing Emergency?<br><span style="opacity:.85;font-size:.85em;">We're Available Right Now.</span></h2>
                <p class="hwh-cta__text">Don't let a burst pipe or overflowing drain turn into a renovation. Our emergency crew is standing by 24 hours a day, 7 days a week.</p>
            </div>
            <div class="hwh-cta__actions">
                ...
                <a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>" class="hwh-btn hwh-btn--ghost-white hwh-btn--lg">Schedule Online</a>
            </div>
        </div>
    </section>
