...
// NOTE: The portfolio 'Project Gallery' and 'Project Details' custom metaboxes have
// been intentionally removed. They were blocking Yoast SEO's full meta panel.
// Any previously saved data (_portfolio_gallery, _portfolio_location, _portfolio_year,
// _portfolio_duration) is preserved in the database and accessible via the built-in
// Custom Fields panel (enabled above via 'custom-fields' support).
